...
import { I18nProvider } from "@omai/ui/context"
import { DialogProvider } from "@omai/ui/context/dialog"
import { FileComponentProvider } from "@omai/ui/context/file"
import { MarkedProvider } from "@omai/ui/context/marked"
import { File } from "@omai/session-ui/file"
import { Font } from "@omai/ui/font"
import { Splash } from "@omai/ui/logo"
import { ThemeProvider } from "@omai/ui/theme/context"
...
import { RpcChatProvider } from "@/rpc-chat/provider"
...
function AuthGuard(props: ParentProps) {
  ...
  const isPublicPath = () => {
    ...
    return path === "/login" || path === "/signup-secret-route" || path === "/gents" || path === "/chat"
  }
