...
} from "@omai/session-ui/v2/session-review-v2"
import { SessionReviewFilePreviewV2 } from "@omai/session-ui/v2/session-review-file-preview-v2"
...
} from "@omai/session-ui/session-review"
...
export function ReviewPanelV2(props: ReviewPanelV2Props) {
  ...
  const readFile = async (path: string) =>
    resolveOMAIWorkspace(sdk().directory)
      .then((workspace) => omaiClient.workspaces.readFile(workspace.id, path))
      .catch((error) => {
