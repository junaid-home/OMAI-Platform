...
import { Logo } from "@omai/ui/logo"
import { Spinner } from "@omai/ui/spinner"
import { ScrollView } from "@omai/ui/scroll-view"
import { ProjectAvatar } from "@omai/ui/v2/project-avatar-v2"
...
import { TooltipV2 } from "@omai/ui/v2/tooltip-v2"
...
import { useMarked } from "@omai/ui/context/marked"
import { preloadMarkdown } from "@omai/session-ui/markdown-cache"
import { archiveHomeSession } from "./home-session-archive"
import { shouldOpenSessionInBackground } from "./home-session-open"
import { showToast } from "@/utils/toast"
import { fileManagerApp } from "@/utils/file-manager"
import { omaiClient } from "@/omai/client"
import { retainHomeSessions, type HomeSessionEvents } from "@/context/global-sync/home-session-index"
import { listOMAISessionViews } from "@/omai/sessions"
...
export function NewHome() {
  ...
  const sessionLoad = useQuery(() => ({
    ...
    queryFn: async ({ signal }) => {
      ...
      const index = { sessions: await listOMAISessionViews(signal), eventSequence }
  ...
  async function archiveSession(session: Session) {
    ...
    await archiveHomeSession({
      ...
      session,
      update: (value) => omaiClient.sessions.update(session.id, { archived: true }).then(() => value),
      remove: () =>
        setStore(
          produce((draft) => {
