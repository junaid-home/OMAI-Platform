...
beforeAll(async () => {
  ...
  mock.module("@omai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@omai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@omai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@omai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
  mock.module("@omai/ui/dropdown-menu", () => {
    const Part = (props: { children?: unknown }) => props.children
    return {
